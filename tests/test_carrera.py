...
class TestCarrera(TestCase):
    ...
    def test_editar_carrera(self):
        ...
        endpoint_crear_carrera = "/usuario/{}/carreras".format(
            str(self.usuario_code))
        headers = {'Content-Type': 'application/json',
                   "Authorization": "Bearer {}".format(self.token)}
        ...
        respuesta_al_crear_carrera = json.loads(
            solicitud_nueva_carrera_1.get_data())
        ...
        self.assertEqual(
            carrera_editada["nombre_carrera"], "Sakhir 130 vueltas")
    ...
    def test_obtener_carrera_por_id(self):
        ...
        carrera_obtenida = json.loads(
            solicitud_consultar_carrera_por_id.get_data())
    ...
    def test_obtener_carreras(self):
        ...
        total_carreras_antes = len(json.loads(
            solicitud_consultar_carreras_antes.get_data()))
        ...
        total_carreras_despues = len(json.loads(
            solicitud_consultar_carreras_despues.get_data()))
